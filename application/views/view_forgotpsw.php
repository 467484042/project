				...
				<div class="panel-body">
					<div class="text-center">
						...
						<div class="panel-body">
							...
							<form action="<?php echo base_url()."project/index.php/resetpsw/sendCode"?>" id="register-form" role="form" autocomplete="on" class="form" method="post">
								...
								<div class="form-group">
									<input id="submitBtn" name="recover-submit" class="btn btn-lg btn-primary btn-block" value="Reset Password" type="submit">
								</div>
							</form>
